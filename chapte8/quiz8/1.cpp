/*We wrote a program to simulate a ball falling off of a tower. 
...
int main()
{
	double towerHeight{ Tower::getTowerHeight() };

    int seconds {};
    
    while (Tower::calculateAndPrintBallHeight(towerHeight, seconds++) > 0.0){
        ;
    }
