...
When performing resize or insertion operations, move elements only if their move constructor is noexcept, otherwise copy them (std::move_if_noexcept).
Provide a strong exception safety guarantee for resize or insertion operations (topic - exception specifications and noexcept).*/
