...
int main(){
    ...
    for(int i = 0; i < 6; i++){
        ...
        if (height > tower_height){
            ...
            std::cout<<"At "<<i<<" seconds, the ball is at height: "<<tower_height - height<<" meters"<<std::endl;
    }
